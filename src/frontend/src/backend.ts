...
export class Backend implements backendInterface {
    ...
    async getAllRecords(): Promise<Array<RawRecord>> {
        if (this.processError) {
            try {
    ...
    async getMyRecords(): Promise<Array<RawRecord>> {
        if (this.processError) {
            try {
    ...
    async submitPrediction(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPrediction(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
